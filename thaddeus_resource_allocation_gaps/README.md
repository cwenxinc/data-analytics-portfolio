...
- Perceived productivity varied across roles, with nonprofit leadership reporting the greatest difficulty with consistent task completion. Post-hoc ANOVA found that **only the difference between nonprofit leadership and resource navigators was statistically significant** (Tukey adjusted p-value = 0.039; 95% CI for difference in means excluded 0).
...
- Higher perceived training adequacy was strongly associated with greater self-reported productivity across all roles, particularly among resource navigators (r = 0.96, Pearson correlation p-value = 0.00075). However, **training gaps varied by role**: nonprofit leadership reported broad needs across multiple areas, care coordinators and therapists prioritized client-focused training, and case managers requested additional technical training on internal tools.
- Management support emerged as another area for improvement, **particularly among nonprofit leadership and therapists, who perceived communication and problem-solving to be less effective**. Higher perceived management support was associated with greater self-reported productivity across all roles, with the association reaching marginal statistical significance among care coordinators (r = 0.93, Pearson correlation p-value = 0.07).

Recognizing that staff needs differed considerably by role, recommendations were tailored to address the specific needs of each group. Broadly speaking, we recommended: 
- Developing role-specific training resources with different training priorities
- Designating and training department representatives to streamline approval processes and improve information flow between leadership and staff
