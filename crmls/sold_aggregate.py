...
sold_2026.shape # (82147, 80)

# NOTE: 2024 data has 4 more fields than 2025 and 2026 data
# investigate field discrepancy
np.sum(sold_2025.columns != sold_2026.columns)  # 2025 and 2026 fields match exactly
set(sold_2024.columns) - set(sold_2025.columns) # 2025 and 2026 data don't have buyer agency compensation, buyer agency compensation type, originating system name, and originating system subname, none of which is essential information
set(sold_2024.columns) - set(sold_2026.columns)
